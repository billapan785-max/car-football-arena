...
const MODES: ModeInfo[] = [
  {
    id: 'ranked',
    bgImage: '/Rankedbutton.png?v=2',
    themeColor: '#ff5500',
    glowColor: 'rgba(255, 85, 0, 0.7)',
  },
  {
    id: '2v2',
    bgImage: '/Casualbutton.png?v=2',
    themeColor: '#00d2ff',
    glowColor: 'rgba(0, 210, 255, 0.7)',
  },
  {
    id: '1v1',
    bgImage: '/DuelButton.png?v=2',
    themeColor: '#9d4edd',
    glowColor: 'rgba(157, 78, 221, 0.7)',
  },
  {
    id: 'practice',
    bgImage: '/Practicebutton.png?v=2',
    themeColor: '#10b981',
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 z-[9999] flex flex-col items-center justify-center p-4 no-scrollbar overflow-y-auto"
        style={{
          backgroundImage: 'url("/selectmode.png?v=2")',
      ...
      >
        ...
        {/* Cards Row/Grid Container (Aligned in a single horizontal line on all screens) */}
        <div className="grid grid-cols-4 gap-2 sm:gap-4 md:gap-6 w-full max-w-4xl px-2 sm:px-4 py-8 justify-center justify-items-center items-center">
          {MODES.map((mode, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative rounded-xl border-2 cursor-pointer transition-all duration-300 select-none overflow-hidden shrink-0 group w-full max-w-[75px] sm:max-w-[130px] md:max-w-[150px] h-[105px] sm:h-[190px] md:h-[220px]"
                style={{
