...
export default function GarageCanvas({ 
  ...
  useEffect(() => {
    ...
    // Tone mapping to make colors pop like a bright sunny day
    ...
    const mountCar = () => {
      ...
      const carData = createCarModel(color, accent, 1.0, modelUrl, customRotation);
  ...
  }, [color, accent, carY, carZ, carScale, backgroundImage, modelUrl, customRotation]);
